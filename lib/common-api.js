...
class MyfoxWrapperApiCommon {
  ...
  constructor (options, fallbackApi, accountCredentials) {
    ...
    // persistent states are event triggerers
    this.eventListenerRegistry = {} // TODO !1: a faire
    this.persistentStates = {
      status: persistentState(baseEvent('status', this.eventListenerRegistry)),
      alarm: persistentState(baseEvent('alarm', this.eventListenerRegistry))
    }
  }
