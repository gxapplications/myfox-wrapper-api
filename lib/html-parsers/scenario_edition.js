...
// TODO !1: test all cases, and make tests!
  ...
  trumpetParser.select('form#scenarioForm input[name="_trigger_type"][value="4"]', trumpetAttr('checked', (value) => {
    trumpetParser.data.trigger_4 = {}
    console.log('main is checked')
    // TODO !0 plug new trumpetParser.select(...)s to have trumpetParser.data.trigger_4 = {deviceSlaveId, value, operator}
    // TODO !0 : is it too late to add it ? or should be added in all cases, with a condition inside...
  }))
