...
// TODO !1: tests here, in a new mock
...
// TODO !0: tests here, in the first mock
  // Condition: time
  trumpetParser.select('form#scenarioForm div.conditions input[type="checkbox"][name="_condition_1"][value="1"][checked="checked"]', (element) => {
    trumpetParser.select(
      'form#scenarioForm div.conditions input[type="text"][name="time1"]',
      trumpetAffectValue(trumpetParser.nextPayload, 'time1')
    )
    trumpetParser.select(
      'form#scenarioForm div.conditions input[type="text"][name="time2"]',
      trumpetAffectValue(trumpetParser.nextPayload, 'time2')
    )
    trumpetParser.select(
      'form#scenarioForm div.conditions input[type="hidden"][name="day"]',
      trumpetAffectValue(trumpetParser.nextPayload, 'day')
    )
    trumpetParser.select(
      'form#scenarioForm div.conditions input[type="hidden"][name="idx"]',
      trumpetAffectValue(trumpetParser.nextPayload, 'idx')
    )
    trumpetParser.select(
      'form#scenarioForm div.conditions input[type="hidden"][name="_condition[1]"]',
      trumpetAffectValue(trumpetParser.nextPayload, '_condition[1]')
    )
  })

// TODO !2: tests here, in the first mock
  ...
  trumpetParser.select('form#scenarioForm div.conditions input[type="checkbox"][name="_condition_4_1"][value="4"][checked="checked"]', (element) => {
    // TODO !2: ajouter les parsers, comme en L.181 ? puis:
    trumpetParser.select('form#scenarioForm div.conditions input[type="checkbox"][name="_condition_4_2"][value="4"][checked="checked"]', (element) => {
      // TODO !2 un peu pareil
    })
  })

// TODO !3: tests here, in the first mock
  ...
  trumpetParser.select('form#scenarioForm div.conditions input[type="checkbox"][name="_condition_5_1"][value="5"][checked="checked"]', (element) => {
    // TODO !3: ajouter les parsers, comme pour temperature, ou presque (select remplacent des text)
...
export function step3TempFixer (payload, settings) {
  // TODO !4: fixer la payload avec les settings...
