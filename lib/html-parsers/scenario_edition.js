 ...
 *   <input type="radio" name="_action[securityLevel]" value="2" disabled="disabled">
 *   <input type="radio" name="_action[securityLevel]" value="1" disabled="disabled">
 * ==> input[type="radio"][name="_action[securityLevel]"][checked="checked"]
 *
 * Domotic/groups/other commands ON/OFF
 *   <input type="checkbox" name="_cbxXXXXXX" value="1" disabled="disabled">
 *   <input type="hidden" name="_action[g][XXXXX]" value="" disabled="disabled">
 *   <input type="checkbox" name="_cbxXXXXX" value="1" disabled="disabled">
 *   <input type="hidden" name="_action[d][XXXXX]" value="" disabled="disabled">
 * ==>  div.tab-domotic   input[type="checkbox"][name^="_cbx"][checked="checked"]
 ...
 *
 * <input type="checkbox" name="ringtone" value="1" disabled="disabled">
 * ==> input[type="checkbox"][name="ringtone"][checked="checked"]
 *
 * Scenario play:
 *   <input type="checkbox" name="_cbxXXXXXXXX" value="1" disabled="disabled"> de
 *   <input type="text" name="delayPlay" value="30" class="seconds" disabled="disabled"> secondes
 *   <input type="checkbox" name="_cbxXXXXXXXX" value="1" disabled="disabled"> après
 *   <input type="text" name="delayReverse" value="30" class="seconds" disabled="disabled"> secondes
 *   <select name="_action[runScenarioId]">
 *     <option value="">Choisissez un de vos scénarios à la demande</option>
 *     <option value="xxxxx" selected="selected">AA test rien</option>
 *     <option value="xxxxxx">Ch Chbres Confort 2h</option>
 *   </select>
 * ==>  div.tab-scenario  input[type="checkbox"][name^="_cbx"][checked="checked"]
 *                        input[type="text"][name="delayPlay"]
 *                        input[type="text"][name="delayReverse"]
 *                        select[name="_action[runScenarioId]"] option[selected="selected"]
 *
 * @param  {MyfoxWrapperApiCommon}  wrapperApi  The Api instance, to throw events
 * @return {trumpet}                The trumpet parser to plug on the HTML stream.
 */
export function step4Parser (wrapperApi) {
  ...
  trumpetParser.selectAll(
    'form#scenarioForm div.tab-domotic input[type="checkbox"][name^="_cbx"][checked="checked"]',
    trumpetAffectValue(trumpetParser.nextPayload)
  )
  trumpetParser.selectAll(
    'div.tab-domotic input[type="hidden"][name^="_action"]',
    trumpetAffectValue(trumpetParser.nextPayload)
  )
  ...
  // Ringtone
  trumpetParser.selectAll(
    'form#scenarioForm input[type="checkbox"][name="ringtone"][checked="checked"]',
    trumpetAffectValue(trumpetParser.nextPayload)
  )

  // Scenario play
  trumpetParser.selectAll(
      'form#scenarioForm div.tab-scenario input[type="checkbox"][name^="_cbx"][checked="checked"]',
      trumpetAffectValue(trumpetParser.nextPayload)
  )
  trumpetParser.selectAll(
      'form#scenarioForm div.tab-scenario input[type="text"][name="delayPlay"]',
      trumpetAffectValue(trumpetParser.nextPayload)
  )
  trumpetParser.selectAll(
      'form#scenarioForm div.tab-scenario input[type="text"][name="delayReverse"]',
      trumpetAffectValue(trumpetParser.nextPayload)
  )
  trumpetParser.selectAll(
      'form#scenarioForm div.tab-scenario select[name="_action[runScenarioId]"] option[selected="selected"]',
      trumpetAffectValue(trumpetParser.nextPayload, '_action[runScenarioId]')
  )
...
export function step3TempFixer (payload, settings) {
  // TODO !3: fixer la payload avec les settings... Faire apres les tests
