...
import { step1Parser, step2Parser, step3TempInspectionParser, step3TempModificationParser, step4Parser, step5Parser } from './html-parsers/scenario_edition'
...
class MyfoxWrapperApiHtml extends MyfoxWrapperApiCommon {
  ...
  updateScenarioTemperatureSettings (scenarioId, settings, callback) {
    ...
    this.callApi(url1, 'GET', step1Parser(this), {}, {}, {})
      ...
      .then((parser3) => {
        return this.callApi(url4, 'POST', step4Parser(this), {}, {}, parser3.nextPayload)
      })
      .then((parser4) => {
