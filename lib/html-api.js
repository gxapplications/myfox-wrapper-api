...
class MyfoxWrapperApiHtml extends MyfoxWrapperApiCommon {
  ...
  authenticate (authData, callback) {
    ...
    // TODO !1: manage this response and display its message: 200 avec {"code":"KO","msg":[["Identification failed for the following reason: Too many connection attempts.","error"]]}
    httpsRequest(
      'POST',
      ...
      // FIXME !3: les recuperer d'ou ? de super.accountCredentials si ils existent, sinon on peut pas (error a renvoyer au client ?)
    )
  }
