...
import { step1Parser, step2Parser, step3TempInspectionParser } from './html-parsers/scenario_edition'
...
class MyfoxWrapperApiHtml extends MyfoxWrapperApiCommon {
  ...
  /**
   * TODO !0: doc, settings format
   */
  updateScenarioTemperatureSettings (scenarioId, settings, callback) {
    console.log('TODO', scenarioId, settings)
    callback(null, 'ok')
    // TODO !1: stuff. 1: check settings format. 2: call updates for scenarioId
  }
}
