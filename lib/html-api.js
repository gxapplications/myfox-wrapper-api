...
class MyfoxWrapperApiHtml extends MyfoxWrapperApiCommon {
  ...
  authenticate (authData, callback) {
    ...
    try {
      ...
      // TODO !0: ajout du cookie! on doit donc faire un pré-appel à / puis gérer dans la lib html le Set-Cookie de façon générique.
      // 1. on requete en GET sur https://myfox.me, on récupère le Set-Cookie: sfmid=<blabla a recuperer!>; expires=<...>; path=/
      // 2. la partie sfmid doit etre memo et réutilisée pour la requete POST /login
